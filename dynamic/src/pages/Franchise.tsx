      ...
      >
        ...
        <div className="container mx-auto px-4 lg:px-6 relative z-20">
          ...
          >
            ...
            >
              <div className="w-1.5 h-1.5 bg-gp-accent rounded-full animate-pulse" />
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/70">
                Pioneering Indian Real Estate
              </span>
            </motion.div>
            
            {/* Main Heading */}
            <h1 className="text-white mb-6 leading-[1.1] tracking-tight">
              <motion.span
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.4 }}
                className="block text-4xl md:text-5xl lg:text-6xl font-light mb-2"
              >
                Your Gateway to
              </motion.span>
              <motion.span
                ...
                className="block text-6xl md:text-7xl lg:text-8xl font-display font-bold"
              >
                Construction <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-gp-accent via-white to-gp-accent">
                  Franchising Success
                </span>
              </motion.span>
            </h1>
            ...
            <motion.div
              ...
              className="max-w-2xl text-left space-y-6 mb-10"
            >
              <p className="text-lg md:text-xl text-white/90 leading-relaxed font-medium">
                India&apos;s first comprehensive <span className="text-gp-accent font-bold">&quot;Approval to Key&quot;</span> franchise model, 
                providing specialized business support and technical vocational training.
              </p>
              <div className="h-px w-20 bg-gradient-to-r from-gp-accent to-transparent" />
              <p className="text-sm md:text-base text-white/60 leading-relaxed max-w-xl">
                Our &quot;Paid Socialised Service&quot; model ensures you enter the market with strong branding, 
                proven technical benchmarking, and vocational training on capturing your local market.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-6 justify-start items-center sm:items-start"
            >
              <motion.button
              ...
              >
                ...
                <span className="relative text-[11px] font-black uppercase tracking-[0.3em] flex items-center gap-3">
