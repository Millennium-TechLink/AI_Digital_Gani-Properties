  ...
  return (
    <>
      <SEOHead
        ...
        description="Contact Gani Properties for your real estate needs in Bangalore. Call +91 99005 70799, email info@ourganiproperties.com, or visit us in Bengaluru. Schedule site visits for properties in Kattigenahalli, Yelahanka, Hunasamaranahalli, and Chikkaballapur."
        keywords={[
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      },
                      {
                        icon: Mail,
                        title: 'Email',
                        content: 'info@ourganiproperties.com',
                        link: 'mailto:info@ourganiproperties.com',
                      },
                      {
                        icon: Clock,
