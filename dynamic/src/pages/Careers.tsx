                  ...
                  <motion.div key={category} initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                    <div className="flex flex-col lg:flex-row gap-12 items-start">
                      ...
                      <div className="lg:w-2/3 flex flex-col gap-4 w-full">
                        {roles.map((job) => (
                          <div key={job.id} className="bg-white rounded-2xl border border-gp-ink/10 hover:border-[#0F3A3D]/30 hover:shadow-xl transition-all duration-300 overflow-hidden">
                            {/* Card Header */}
                            <div
                  ...
                  {submitSuccess ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input
                          className="w-full px-3 py-2.5 border border-gp-ink/20 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#0F3A3D]/30 focus:border-[#0F3A3D] transition-all"
                          value={formData.name}
                          ...
                          <>
                            ...
                            {resumeFile ? (
                              ...
                              <button type="button" onClick={() => fileInputRef.current?.click()}
                                className="w-full border-2 border-dashed border-gp-ink/20 hover:border-[#0F3A3D]/40 rounded-xl p-5 text-center transition-all hover:bg-[#0F3A3D]/5 group">
                                <Upload size={22} className="mx-auto mb-1.5 text-gp-ink-muted group-hover:text-[#0F3A3D] transition-colors" />
                      ...
                      <div className="space-y-1.5">
                        ...
                        <textarea
                          className="w-full px-3 py-2.5 border border-gp-ink/20 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#0F3A3D]/30 focus:border-[#0F3A3D] transition-all resize-none"
                          rows={5}
                      ...
                      <div className="pt-1 flex gap-3">
                        ...
                        <button type="submit" disabled={submitting}
                          className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#C9B589] to-[#b8a070] text-[#0F3A3D] font-bold rounded-xl text-sm hover:opacity-90 transition-all disabled:opacity-60">
                          {submitting
