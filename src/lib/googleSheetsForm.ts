 ...
 * 
 * Google Apps Script URL (hardcoded for reliability):
 ...
 * 
 * This is a standalone function that works independently of any backend.
 * It directly communicates with Google Apps Script Web App.
 * 
...
export async function submitToGoogleSheets(
  ...
  try {
    ...
    // Honeypot spam check - if honeypot field is filled, it's likely a bot
    ...
    const payload = {
      name: data.name.trim(),
      phone: data.phone.replace(/\D/g, ''), // Clean phone number (digits only)
