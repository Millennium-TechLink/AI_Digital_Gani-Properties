            ...
            >
              ...
              >
                <motion.div
                  ...
                  className="bg-white rounded-3xl shadow-2xl w-full max-w-lg flex flex-col max-h-[90vh] overflow-hidden relative"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        {resumeMode === 'file' ? (
                          <>
                            ...
                            {resumeFile ? (
                              <div className="flex items-center gap-3 p-2 bg-green-50 border border-green-200 rounded-xl">
                      ...
                      <div className="pt-1 flex gap-3">
                        <button type="button" onClick={closeModal}
                          className="flex-1 px-4 py-2 border border-gp-ink/20 rounded-xl text-sm font-semibold text-gp-ink hover:bg-gray-50 transition-all">
                          Cancel
                        </button>
